            ...
            <div class="card bg-light mb-3">
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td class="text-right text-success"><code><a href="/<?= Settings::$site_dir ?>version_log.php">Посмотреть</a></code></td>
                    </tr>
                    </tbody>
                </table>
                <div class="card-header text-center border-top">
                ...
                <div class="card-footer text-muted text-center">
                    Рекомендуем ознакомиться с <a href="/<?= Settings::$site_dir ?>manual/">руководством</a> к фрэймворку
                </div>
                <div class="card-footer text-muted text-center">
                    Так же Вы можете перейти в <a href="/<?= Settings::$site_dir ?><?= Settings::$admin_partition ?>">админку</a> фрэймворка
                </div>
                <div class="card-footer text-muted text-center">
                    Скачать <a href="/xc2022.rar" download>архив</a> последней версии SimpleCode
                </div>
            </div>
        </div>
    </div>
