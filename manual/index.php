        ...
        <div class="row mb-3">
            <div class="col-md-3 list-group">
                <div class="text-center">
                    ...
                    <a href="index.php?part=16" class="list-group-item list-group-item-action <?= $_GET['part'] == 13 ? 'active' : false;?>" style="border-left: none !important; border-right: none !important">Роутинги</a>
