...
<div class="code_block mb-2">
    <ol>
        ...
        <li><span class="line_code"><span class="class">Storage</span>::<span class="method">disk</span>(<span class="data">'public'</span>)-><span class="method">get</span>(<span class="data">'test'</span>)-><span class="method">fromJson()</span>;</span></li>
        <li></li>
