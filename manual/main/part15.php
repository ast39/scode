...
<div class="code_block mb-2">
    <ol>
        <li>
            <span class="line_code"><span class="keywords">namespace</span> controllers\components;</span>
        </li>
        <li></li>
        <li>
            <span class="line_code"><span class="keywords">use</span> core\Component;</span>
        </li>
        <li></li>
        <li>
